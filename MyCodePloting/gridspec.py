...
_wraps_plot_acc_graph = partial(_wraps_plot, func=acc_graph)
_wraps_plot_acc_embedding = partial(_wraps_plot, func=acc_embedding)
_wraps_plot_acc_embedding_grid = partial(_wraps_plot, func=acc_embedding_grid)
_wraps_plot_acc_embedding_stream = partial(
    _wraps_plot, func=acc_embedding_stream
)
...
class GridSpec:
    ...
    # TODO: Add docstrings
    @_wraps_plot_acc_embedding
    def acc_embedding(self, adata, **kwargs):
        """TODO."""
        return acc_embedding(adata, **self.get_kwargs(kwargs))

    # TODO: Add docstrings
    @_wraps_plot_acc_embedding_grid
    def acc_embedding_grid(self, adata, **kwargs):
        """TODO."""
        return acc_embedding_grid(adata, **self.get_kwargs(kwargs))

    # TODO: Add docstrings
    @_wraps_plot_acc_embedding_stream
    def acc_embedding_stream(self, adata, **kwargs):
        """TODO."""
        return acc_embedding_stream(adata, **self.get_kwargs(kwargs))

    # TODO: Add docstrings
    @_wraps_plot_acc_graph
    def acc_graph(self, adata, **kwargs):
        """TODO."""
        return acc_graph(adata, **self.get_kwargs(kwargs))
