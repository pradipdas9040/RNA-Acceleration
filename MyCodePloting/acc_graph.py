...
from MyCodeTools.transition_matrix import transition_matrix
...
def acc_graph(
    ...
    **kwargs,
    ...
    """Plot of the acc graph.

    Arguments
    ---------
    adata: :class:`~anndata.AnnData`
        Annotated data matrix.
    which_graph: `'acc_graph'` or `'connectivities'`  (default: `None`)
        Whether to show transitions from acc graph or neighbor connectivities.
    n_neighbors: `int` (default: 10)
        Number of neighbors to be included for generating connectivity / acc graph.
