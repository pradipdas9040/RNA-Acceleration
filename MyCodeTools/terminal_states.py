...
from .acc_graph import accGraph
...
def cell_fate(
    ...
    _adata.uns["acc_graph"] = vgraph.graph
    _adata.uns["acc_graph_neg"] = vgraph.graph_neg
...
def terminal_states(
    ...
    **kwargs,
    ...
    acc-inferred transition matrix and its transposed, respectively,
